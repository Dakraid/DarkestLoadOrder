...
namespace DarkestLoadOrder.Json.SteamWebAPI
{
    ...
    public class Response
    {
        ...
        [JsonProperty("publishedfiledetails")] public List<Publishedfiledetail> Publishedfiledetails { get; set; }
    }

    public class Publishedfiledetail
    {
        [JsonProperty("publishedfileid")] public ulong Publishedfileid { get; set; }

        [JsonProperty("result")] public long Result { get; set; }

        [JsonProperty("creator")] public string Creator { get; set; }

        [JsonProperty("creator_app_id")] public long CreatorAppId { get; set; }

        [JsonProperty("consumer_app_id")] public long ConsumerAppId { get; set; }
        ...
        [JsonProperty("banned")] public long Banned { get; set; }

        [JsonProperty("ban_reason")] public string BanReason { get; set; }

        [JsonProperty("subscriptions")] public long Subscriptions { get; set; }

        [JsonProperty("favorited")] public long Favorited { get; set; }

        [JsonProperty("lifetime_subscriptions")]
        public long LifetimeSubscriptions { get; set; }

        [JsonProperty("lifetime_favorited")] public long LifetimeFavorited { get; set; }
